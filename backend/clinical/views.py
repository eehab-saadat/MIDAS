...
class ClinicianViewSet(viewsets.ModelViewSet):
    ...
    Supports filtering via ?search=<term> (matches name or title).
    """
...
class EncounterViewSet(viewsets.ModelViewSet):
    ...
    Filter by clinician with ?clinician=<clinician_id>.
    """
...
class MedicationViewSet(viewsets.ModelViewSet):
    ...
    Filter by patient with ?patient=<patient_id>.
    Supports searching via ?search=<term> (matches medication_name or active_agent_name).
    """
